...
/**
 * Extends the Unity3D Activity to check for HTC Scribe pen events.
 * To use, follow the instructions under the section called
 * "Extending the UnityPlayerActivity Java Code" here:
 * http://unity3d.com/support/documentation/Manual/Plugins.html
 *
 */
public class PenUnityActivity extends UnityPlayerActivity {
	
	/**
	 * The tag to be output for logging messages.
	 */
	private static final String LOG_TAG = PenUnityActivity.class.getSimpleName();
