...
public class ColorSelectorDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final PhotoBackWriterApp app = PhotoBackWriterApp.getApp(getContext());
		
		final CheckBox enableJaja = new CheckBox(getContext());
		enableJaja.setText("Use Jaja Pen");
		enableJaja.setChecked(app.mPrefs.isJajaEnabled());
		enableJaja.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				app.mPrefs.setJajaEnabled(isChecked);
			}
		});
		mainContent.addView(enableJaja);
